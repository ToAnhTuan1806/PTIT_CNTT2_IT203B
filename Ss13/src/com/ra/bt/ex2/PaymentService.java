...
Khi xảy ra lỗi ở bước cập nhật hóa đơn, chương trình chỉ in lỗi ra màn hình rồi dừng lại
Lúc này giao dịch chưa được commit nhưng cũng không được hủy bỏ rõ ràng,
    nên kết nối có thể bị treo và dữ liệu ở trạng thái không an toàn
Trong Transaction khi có lỗi thì bắt buộc phải rollback() để hủy toàn bộ thay đổi đã thực hiện
Việc không gọi rollback() là sai nguyên tắc vì Transaction phải đảm bảo “hoặc làm hết, hoặc hủy hết”
 */